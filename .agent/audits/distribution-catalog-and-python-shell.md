...
consumer only included the generated header. The final source follow-up uses a
compile-time assertion over the generated `AMAZON_BRAKET_QDMI_device_initialize`
declaration. This preserves direct header reachability without a runtime call,
helper linkage, lint suppression, generated header change, or live behavior
